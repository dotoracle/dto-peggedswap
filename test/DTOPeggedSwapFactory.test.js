...
describe('DTOPeggedSwapFactory', async () => {
  ...
  it('setFeeToSetter', async () => {
    await expect(factory.connect(other).setFeeToSetter(other.address)).to.be.revertedWith('DTOPeggedSwap: FORBIDDEN')
    await factory.setFeeToSetter(other.address)
    expect(await factory.feeToSetter()).to.eq(other.address)
    await expect(factory.setFeeToSetter(owner.address)).to.be.revertedWith('DTOPeggedSwap: FORBIDDEN')
  })
})
